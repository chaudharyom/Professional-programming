 ...
 */
 ...
 /**@param  evt action event to add new mark  to jLabel5  
 * 
 * @return     
 */
 ...
 /**@param  evt action event to check something is added and set new mark  to jLabel5 and jlabel6 
 * 
 * @return     
 */
 ...
 /**@param  evt action event to get the value typed by user and assign to variable asg1,asg2 and exam 
 * 
 * @return     
 */
  ...
  /**@function  to remove all the student that was selected  
 * 
 * @return     
 */
    ...
    /**@param u add unique code to database        
     */
	public void addUnit(IUnit u) {
		uM.addElement(u.getUnitCode());
	}
/**@param b use boolean condition to set text mark value
 * 
 * 
 */
...
/**@function remove student data in the database
 * 
 */
...
/**@param
 * 
 * @param student get student details and add to database 
 */
...
/**@param
 * 
 * @param b use boolean variable set mark in the field
 */
...
/**@param
 * 
 * @param record get assignment record to set to obtain mark to field
 */
...
/**@function to set all text field empty.
 * 
 */
...
/**@param
 * 
 * @param b use boolean to enable button
 */
